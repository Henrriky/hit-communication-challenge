  ...
  theme: {
    extend: {
      colors: {
        ...
        'status-open-unchecked': 'rgba(158, 246, 167, 0.4)',
        'status-open-checked': 'rgba(158, 246, 167)',
        'status-pending-unchecked': 'rgba(233, 219, 94, 0.4)',
        'status-pending-unchecked': 'rgba(233, 219, 94)',
        'status-closed-unchecked': 'rgba(255, 62, 62, 0.4)',
        'status-closed-checked': 'rgba(233, 219, 94)',
